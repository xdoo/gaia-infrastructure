package de.muenchen.gaia.infrastructure.auth.controller;

import de.muenchen.gaia.infrastructure.auth.dto.AuthorityDto;
import de.muenchen.gaia.infrastructure.auth.dto.UserDto;
import de.muenchen.gaia.infrastructure.auth.entities.Permission;
import de.muenchen.gaia.infrastructure.auth.entities.User;
import de.muenchen.gaia.infrastructure.auth.mapper.UserMapper;
import de.muenchen.gaia.infrastructure.auth.repositories.PermissionRepository;
import de.muenchen.gaia.infrastructure.auth.repositories.UserRepository;
